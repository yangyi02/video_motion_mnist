...
MNIST dataset
Digit has perspective motion (translation, rotation, scaling), background has no motion
...
This experiment is to verify if the model can predict perspective motion.

Take Home Message:

Yes, perspective motion can also be predicted!!!

Note, currently I don't generate ground truth motion for perspective hence there is no quantitative results.
