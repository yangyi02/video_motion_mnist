...
def validate(args, model, images, m_dict, reverse_m_dict, best_test_acc):
    test_acc = test_supervised(args, model, images, m_dict, reverse_m_dict)
...
def train_supervised(args, model, images, m_dict, reverse_m_dict):
    ...
    for epoch in range(args.train_epoch):
        ...
        if (epoch+1) % args.test_interval == 0:
            ...
            best_test_acc = validate(args, model, images, m_dict, reverse_m_dict, best_test_acc)
    return model
