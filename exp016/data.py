...
def generate_images(args, images, m_dict, reverse_m_dict):
    ...
    im1 = move_image(im2, m_b_x, m_b_y, m_range)
    im3 = move_image(im2, m_f_x, m_f_y, m_range)
    gt_motion_f[im1 == 0] = m_dict[(0, 0)]
    gt_motion_b[im3 == 0] = m_dict[(0, 0)]
    im1[im1 == 0] = bg[im1 == 0]
    im2[im2 == 0] = bg[im2 == 0]
    im3[im3 == 0] = bg[im3 == 0]
    if False:
...
def move_image(im, m_x, m_y, m_range):
