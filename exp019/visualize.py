...
def visualize(im1, im2, im3, pred, pred_motion_f, gt_motion_f, disappear_f, attn_f, pred_motion_b, gt_motion_b, disappear_b, attn_b, m_range, m_dict, reverse_m_dict):
    img_size = im1.size(2)
